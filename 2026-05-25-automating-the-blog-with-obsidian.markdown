...
### The Automation
I've used an extension in obsidian called "shell commands", for anyone who's a developer, you can probably just intuit where this article is going. The solution is very simple